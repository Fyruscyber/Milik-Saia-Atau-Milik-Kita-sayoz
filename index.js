...
/////////////////
const BotName = 'XONTOL BOT'; 
const instagram 'Gk Punya :('; 
const apivhtear = 'API_KEY';
const apibarbar = 'API_KEY';
const telegram = 'Kepo Amat Sih'; 
const kapanbotaktif = 'Tergantung Owner'; 
const youtube = 'https://youtu.be/affmdx7mskM';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:IndraFajri64')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@IndraFajri64`)
})
